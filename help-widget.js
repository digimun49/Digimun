(function() {
  ...
  const styles = `
    ...
    .digimun-help-link.low-priority {
      background: rgba(100, 116, 139, 0.15) !important;
      border: 1px solid rgba(100, 116, 139, 0.3) !important;
      padding: 8px 12px !important;
      font-size: 12px !important;
    ...
    .digimun-help-link.low-priority:hover {
      background: rgba(100, 116, 139, 0.25) !important;
    }
    .digimun-help-link.low-priority .icon {
      font-size: 14px !important;
    }
    .digimun-help-link.how-it-works {
      background: rgba(139, 92, 246, 0.15) !important;
      border: 1px solid rgba(139, 92, 246, 0.3) !important;
      padding: 8px 12px !important;
      font-size: 12px !important;
    }
    .digimun-help-link.how-it-works:hover {
      background: rgba(139, 92, 246, 0.25) !important;
    }
    .digimun-help-link.how-it-works .icon {
      font-size: 14px !important;
    }
    .digimun-help-popup {
      position: absolute !important;
